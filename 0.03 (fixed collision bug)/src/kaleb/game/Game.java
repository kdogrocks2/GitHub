...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		...
		if (getGameState() == 1) {
			...
			handler.addObject(new Button(this.getWidth()/2-50, this.getHeight()/2 , "hi",handler,this, ID.Button));
		}
	...
	//Collision is handled in Handler and they are removed if they go off screen to conserve resources
